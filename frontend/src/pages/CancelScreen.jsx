...
function CancelScreen() {
  ...
  return (
    <div className='  h-screen w-full  bg-white  pt-5 m-auto  justify-center space-y-9'>
       ...
       <div className=' w-[80%]  bg-yellow-700 m-auto rounded-lg px-5 py-5 flex flex-col space-y-5'>
...
<p className=' text-xl text-white'>Are you sure you want to cancel the reservation?</p>
        </div>
...
<div className=' items-center justify-center flex  space-y-4 flex-col'>
   ...
   <div className=' flex bg-red-500 hover:bg-red-300 md:py-2 md:px-3 items-center justify-center h-10 w-32  md:w-52  md:h-16 cursor-pointer text-white font-semibold rounded-lg   transition duration-150'>

<Link className=' text-center flex items-center justify-center' >Cancel</Link>
</div>

   <div className=' flex    md:w-52  md:h-16 bg-gray-300 items-center justify-center  w-32  h-10 cursor-pointer text-white font-semibold rounded-lg hover:bg-gray-500 transition duration-150'>

    <Link className=' text-center flex items-center justify-center' >Go Back</Link>
   </div>
